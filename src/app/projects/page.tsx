    ...
    <main className="container w-screen h-full m-auto flex flex-col justify-center items-center pt-12 pb-8 px-8  gap-4">
      ...
      <div className="flex flex-col justify-start items-center w-full h-[440px] md:h-[600px] bg-[#f4f4f4] p-4 pb-0 rounded-xl">
        ...
        <div className="w-full h-full flex justify-center items-end">
          ...
          <div className="group relative w-[280px] md:w-[800px] h-[300px] md:h-[450px] flex justify-center items-end overflow-hidden">
            ...
            <Image
              className="blur-[1px] group-hover:blur-0 group-hover:scale-125 group-hover:rotate-[8deg] absolute w-[140px] h-[180px] bottom-0 right-20 rotate-[18deg] transition-transform duration-[250ms]"
              src={'/proj/proj_note_comp/comp_1.png'} width={160} height={160} alt=""
            />
            <Image
              className="blur-[1px] group-hover:blur-0 group-hover:scale-125 group-hover:-rotate-[10deg] absolute w-[140px] h-[180px] -bottom-2 left-24 -rotate-[18deg] transition-transform duration-[250ms]"
      ...
      <div className="flex flex-col justify-start items-center w-full h-[440px] md:h-[600px] bg-[#f4f4f4] p-4 rounded-xl">
        ...
        <div className="w-full h-full flex justify-center items-end">
          ...
          <div className="group relative w-[280px] md:w-[800px] h-[300px] md:h-[450px] flex justify-center items-end overflow-hidden">
            ...
            <Image
              className="blur-[1px] group-hover:blur-0 group-hover:scale-125 group-hover:rotate-[8deg] absolute w-[140px] h-[300px] bottom-0 right-20 rotate-[18deg] transition-transform duration-[250ms]"
              src={'/proj/proj_loyal_comp/comp_1.png'} width={160} height={160} alt=""
            />
            <Image
              className="blur-[1px] group-hover:blur-0 group-hover:scale-125 group-hover:-rotate-[10deg] absolute w-[140px] h-[300px] -bottom-2 left-24 -rotate-[18deg] transition-transform duration-[250ms]"
