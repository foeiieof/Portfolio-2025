    ...
    <div className="flex flex-col justify-start items-center w-full h-[440px] md:h-[600px] bg-[#f4f4f4] p-4 rounded-xl">
      ...
      <div className="w-full h-full flex justify-center items-end">
        ...
        <div className="group relative w-[430px] md:w-[800px] h-[288px] md:h-[448px] flex justify-center items-end overflow-hidden group">
          ...
          />
          <Image
            className="blur-[1px] group-hover:blur-0 group-hover:scale-125 group-hover:-rotate-[10deg] absolute w-[100px] md:w-[140px] md:h-[280px] h-[230px] -bottom-2  left-6 md:left-24 -rotate-[18deg] transition-transform duration-[250ms]"
